    ...
    <div className='w-full'>
      ...
      <div className="flex w-full h-[4rem] justify-center items-center ">
        <div className="left w-1/2 h-full flex justify-end items-center">
          <h1 className='font-2xl text-2xl font-bold text-[#6F4E37] mr-[5rem]' id="projects">My Projects</h1>
        </div>
      ...
      <div className='w-full items-center flex justify-center '>
        <div className="flex w-3/5 h-[35rem] items-center justify-center ">
          ...
          <div className="right flex flex-col gap-5 w-1/2 h-[30rem] items-start pl-3 justify-center">
            <div className="banner flex w-[27rem] h-[2.2rem] bg-[#dfdfe0] pl-2 ">
              <div className="left flex w-[23rem]  h-full ">
                <h1 className='text-xl font-bold pt-1'>Password Generator</h1>
              ...
              <div className="diagonal w-[4rem] h-full"></div>
            </div>
        ...
        <div className="flex w-3/5 h-[35rem] items-center justify-center">
          <div className="left flex flex-col gap-5 w-1/2 h-[30rem] pl-3 justify-center">
            <div className="banner flex w-[25rem] h-[2.2rem] bg-[#dfdfe0] pl-2 ">
              <div className="left flex w-[21rem] h-full ">
        ...
        <div className="flex w-3/5 h-[35rem] items-center justify-center ">
          ...
          <div className="right flex flex-col gap-5 w-1/2 h-[30rem] items-start pl-3 justify-center">
            <div className="banner flex w-[20rem] h-[2.2rem] bg-[#dfdfe0] pl-2 ">
              <div className="left flex w-[16rem] h-full ">
